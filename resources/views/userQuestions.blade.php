...
<body class="container-fluid">
	...
	<div class="col-md-7 col-md-offset-1 tag">
		<span class="col-md-12 title">{{ trans('auth.username') }}: {{ $username }}</span>
		...
		<div class="col-md-12 question">
				...
				<div>
					...
					<div class="icon">
							<span><i class="fa fa-dot-circle-o" aria-hidden="true"></i> {{ $question->favouriteCount }} <i class="fa fa-eye" aria-hidden="true"></i> {{ $question->viewCount }}</span>
					</div>
				</div>
		</div>
		@endforeach
